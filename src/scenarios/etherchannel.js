  ...
  tasks: [
    {
      ...
      hint: 'interface gi0/1 → channel-group 1 mode active (repeat for gi0/2)',
    ...
    },
    {
      ...
      hint: 'show etherchannel summary — both sides need compatible LACP modes (not passive+passive)',
